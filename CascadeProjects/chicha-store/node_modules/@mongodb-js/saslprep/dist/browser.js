...
const index_1 = __importDefault(import("./index"));
const memory_code_points_1 = import("./memory-code-points");
const code_points_data_browser_1 = __importDefault(import("./code-points-data-browser"));
