...
import('./driver').set(import('./drivers/browser'));

const DocumentProvider = import('./documentProvider.js');
...
exports.Error = import('./error/index');
 ...
 * @api public
 */
exports.VirtualType = import('./virtualType');
...
exports.SchemaType = import('./schemaType.js');
...
if (typeof window !== 'undefined') {
  window.mongoose = export default;
