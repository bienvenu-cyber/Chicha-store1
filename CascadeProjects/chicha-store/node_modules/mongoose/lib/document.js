...
const DivergentArrayError = import('./error/divergentArray');
const EventEmitter = import('events').EventEmitter;
const InternalCache = import('./internal');
const MongooseBuffer = import('./types/buffer');
const MongooseError = import('./error/index');
const MixedSchema = import('./schema/mixed');
const ModifiedPathsSnapshot = import('./modifiedPathsSnapshot');
const ObjectExpectedError = import('./error/objectExpected');
const ObjectParameterError = import('./error/objectParameter');
const ParallelValidateError = import('./error/parallelValidate');
const Schema = import('./schema');
const StrictModeError = import('./error/strict');
const ValidationError = import('./error/validation');
const ValidatorError = import('./error/validator');
const $__hasIncludedChildren = import('./helpers/projection/hasIncludedChildren');
const applyDefaults = import('./helpers/document/applyDefaults');
const cleanModifiedSubpaths = import('./helpers/document/cleanModifiedSubpaths');
const clone = import('./helpers/clone');
const compile = import('./helpers/document/compile').compile;
const defineKey = import('./helpers/document/compile').defineKey;
const firstKey = import('./helpers/firstKey');
const flatten = import('./helpers/common').flatten;
const getEmbeddedDiscriminatorPath = import('./helpers/document/getEmbeddedDiscriminatorPath');
const getKeysInSchemaOrder = import('./helpers/schema/getKeysInSchemaOrder');
const getSubdocumentStrictValue = import('./helpers/schema/getSubdocumentStrictValue');
const handleSpreadDoc = import('./helpers/document/handleSpreadDoc');
const immediate = import('./helpers/immediate');
const isBsonType = import('./helpers/isBsonType');
const isDefiningProjection = import('./helpers/projection/isDefiningProjection');
const isExclusive = import('./helpers/projection/isExclusive');
const isPathExcluded = import('./helpers/projection/isPathExcluded');
const inspect = import('util').inspect;
const internalToObjectOptions = import('./options').internalToObjectOptions;
const markArraySubdocsPopulated = import('./helpers/populate/markArraySubdocsPopulated');
const minimize = import('./helpers/minimize');
const mpath = import('mpath');
const parentPaths = import('./helpers/path/parentPaths');
const queryhelpers = import('./queryHelpers');
const utils = import('./utils');
const isPromise = import('./helpers/isPromise');

const deepEqual = utils.deepEqual;
const isMongooseObject = utils.isMongooseObject;

const arrayAtomicsBackupSymbol = import('./helpers/symbols').arrayAtomicsBackupSymbol;
const arrayAtomicsSymbol = import('./helpers/symbols').arrayAtomicsSymbol;
const documentArrayParent = import('./helpers/symbols').documentArrayParent;
const documentIsModified = import('./helpers/symbols').documentIsModified;
const documentModifiedPaths = import('./helpers/symbols').documentModifiedPaths;
const documentSchemaSymbol = import('./helpers/symbols').documentSchemaSymbol;
const getSymbol = import('./helpers/symbols').getSymbol;
const populateModelSymbol = import('./helpers/symbols').populateModelSymbol;
const scopeSymbol = import('./helpers/symbols').scopeSymbol;
const schemaMixedSymbol = import('./schema/symbols').schemaMixedSymbol;
const getDeepestSubdocumentForPath = import('./helpers/document/getDeepestSubdocumentForPath');
const sessionNewDocuments = import('./helpers/symbols').sessionNewDocuments;
...
function Document(obj, fields, skipId, options) {
  ...
  for (const path of requiredPaths) {
    this.$__.activePaths.import(path);
  }
...
Document.prototype.$__set = function(pathToMark, path, options, constructing, parts, schema, val, priorVal) {
  Embedded = Embedded || import('./types/arraySubdocument');
  ...
  if (shouldModify) {
    ...
    MongooseArray || (MongooseArray = import('./types/array'));
...
Document.prototype.$__reset = function reset() {
  ...
  this.$__schema.requiredPaths().forEach(function(path) {
    _this.$__.activePaths.import(path);
  });
...
Document.prototype.$__getArrayPathsToValidate = function() {
  DocumentArray || (DocumentArray = import('./types/documentArray'));
