...
const SchemaTypes = import('./schema/index');
const VirtualType = import('./virtualType');
const STATES = import('./connectionState');
const VALID_OPTIONS = import('./validOptions');
const Types = import('./types');
const Query = import('./query');
const Model = import('./model');
const applyPlugins = import('./helpers/schema/applyPlugins');
const builtinPlugins = import('./plugins');
const driver = import('./driver');
const legacyPluralize = import('./helpers/pluralize');
const utils = import('./utils');
const pkg = import('../package.json');
const cast = import('./cast');

const Aggregate = import('./aggregate');
const trusted = import('./helpers/query/trusted').trusted;
...
const SetOptionError = import('./error/setOptionError');
...
import('./helpers/printJestWarning');

const objectIdHexRegexp = /^[0-9A-Fa-f]{24}$/;

const { AsyncLocalStorage } = import('node:async_hooks');
...
Mongoose.prototype.DocumentProvider = import('./documentProvider');
...
Mongoose.prototype.SchemaTypeOptions = import('./options/schemaTypeOptions');
...
Mongoose.prototype.mquery = import('mquery');
...
Mongoose.prototype.omitUndefined = import('./helpers/omitUndefined');
...
const mongoose = export default = exports = new Mongoose({
