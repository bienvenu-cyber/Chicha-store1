...
const MongooseMap = import('../../types/map');
const SkipPopulateValue = import('./skipPopulateValue');
const assignRawDocsToIdStructure = import('./assignRawDocsToIdStructure');
const get = import('../get');
const getVirtual = import('./getVirtual');
const leanPopulateMap = import('./leanPopulateMap');
const lookupLocalFields = import('./lookupLocalFields');
const markArraySubdocsPopulated = import('./markArraySubdocsPopulated');
const mpath = import('mpath');
const sift = import('sift').default;
const utils = import('../../utils');
const { populateModelSymbol } = import('../symbols');

export default = function assignVals(o) {
