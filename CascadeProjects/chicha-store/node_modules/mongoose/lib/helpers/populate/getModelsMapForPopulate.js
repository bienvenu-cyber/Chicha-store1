...
const SkipPopulateValue = import('./skipPopulateValue');
...
const getSchemaTypes = import('./getSchemaTypes');
const getVirtual = import('./getVirtual');
const lookupLocalFields = import('./lookupLocalFields');
const mpath = import('mpath');
const modelNamesFromRefPath = import('./modelNamesFromRefPath');
const utils = import('../../utils');

const modelSymbol = import('../symbols').modelSymbol;
const populateModelSymbol = import('../symbols').populateModelSymbol;
const schemaMixedSymbol = import('../../schema/symbols').schemaMixedSymbol;
const StrictPopulate = import('../../error/strictPopulate');

export default = function getModelsMapForPopulate(model, docs, options) {
  let doc;
