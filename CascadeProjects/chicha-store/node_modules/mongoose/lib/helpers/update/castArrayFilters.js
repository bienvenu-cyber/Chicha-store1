...
const castFilterPath = import('../query/castFilterPath');
const cleanPositionalOperators = import('../schema/cleanPositionalOperators');
const getPath = import('../schema/getPath');
const updatedPathsByArrayFilter = import('./updatedPathsByArrayFilter');

export default = function castArrayFilters(query) {
