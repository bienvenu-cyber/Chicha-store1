...
const promiseOrCallback = import('../promiseOrCallback');
const { queryMiddlewareFunctions, aggregateMiddlewareFunctions, modelMiddlewareFunctions, documentMiddlewareFunctions } = import('../../constants');
...
export default = function applyStaticHooks(model, hooks, statics) {
  const kareemOptions = {
