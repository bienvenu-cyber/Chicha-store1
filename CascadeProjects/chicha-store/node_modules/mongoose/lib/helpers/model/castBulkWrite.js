...
const applyTimestampsToChildren = import('../update/applyTimestampsToChildren');
const applyTimestampsToUpdate = import('../update/applyTimestampsToUpdate');
const cast = import('../../cast');
const castUpdate = import('../query/castUpdate');
const clone = import('../clone');
const decorateUpdateWithVersionKey = import('../update/decorateUpdateWithVersionKey');
const { inspect } = import('util');
const setDefaultsOnInsert = import('../setDefaultsOnInsert');
...
export default = function castBulkWrite(originalModel, op, options) {
  const now = originalModel.base.now();

  if (op['insertOne']) {
    return callback => export default.castInsertOne(originalModel, op['insertOne'], options).then(() => callback(null), err => callback(err));
  } else if (op['updateOne']) {
    return (callback) => {
      try {
        export default.castUpdateOne(originalModel, op['updateOne'], options, now);
        callback(null);
      } catch (err) {
        callback(err);
      }
    ...
    return (callback) => {
      try {
        export default.castUpdateMany(originalModel, op['updateMany'], options, now);
        callback(null);
      } catch (err) {
        callback(err);
      }
    ...
    return (callback) => {
      export default.castReplaceOne(originalModel, op['replaceOne'], options).then(() => callback(null), err => callback(err));
    };
  } else if (op['deleteOne']) {
    return (callback) => {
      try {
        export default.castDeleteOne(originalModel, op['deleteOne']);
        callback(null);
      } catch (err) {
        callback(err);
      }
    ...
    return (callback) => {
      try {
        export default.castDeleteMany(originalModel, op['deleteMany']);
        callback(null);
      } catch (err) {
        callback(err);
      }
...
export default.castInsertOne = async function castInsertOne(originalModel, insertOne, options) {
...
export default.castUpdateOne = function castUpdateOne(originalModel, updateOne, options, now) {
  if (!updateOne['filter']) {
...
export default.castUpdateMany = function castUpdateMany(originalModel, updateMany, options, now) {
...
export default.castReplaceOne = async function castReplaceOne(originalModel, replaceOne, options) {
...
export default.castDeleteOne = function castDeleteOne(originalModel, deleteOne) {
...
export default.castDeleteMany = function castDeleteMany(originalModel, deleteMany) {
...
export default.cast = {
  insertOne: export default.castInsertOne,
  updateOne: export default.castUpdateOne,
  updateMany: export default.castUpdateMany,
  replaceOne: export default.castReplaceOne,
  deleteOne: export default.castDeleteOne,
  deleteMany: export default.castDeleteMany
};
