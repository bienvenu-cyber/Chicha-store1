...
const cleanPositionalOperators = import('../schema/cleanPositionalOperators');
const get = import('../get');
const getDiscriminatorByValue = import('../discriminator/getDiscriminatorByValue');
const updatedPathsByArrayFilter = import('../update/updatedPathsByArrayFilter');
...
export default = function getEmbeddedDiscriminatorPath(schema, update, filter, path, options) {
