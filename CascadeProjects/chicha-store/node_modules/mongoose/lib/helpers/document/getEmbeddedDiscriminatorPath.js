...
const getSchemaDiscriminatorByValue = import('../discriminator/getSchemaDiscriminatorByValue');
...
export default = function getEmbeddedDiscriminatorPath(doc, path, options) {
  options = options || {};
