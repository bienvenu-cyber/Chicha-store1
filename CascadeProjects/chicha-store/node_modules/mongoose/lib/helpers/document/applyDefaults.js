...
const isNestedProjection = import('../projection/isNestedProjection');

export default = function applyDefaults(doc, fields, exclude, hasIncludedChildren, isBeforeSetters, pathsToSkip, options) {
