...
const EE = import('events').EventEmitter
const cons = import('constants')
const fs = import('fs')

export default = (f, options, cb) => {
...
export default.sync = export default.touchSync = (f, options) =>
  (new TouchSync(validOpts(options, f, null)), undefined)

export default.ftouch = (fd, options, cb) => {
  if (typeof options === 'function')
    cb = options, options = {}
...
export default.ftouchSync = (fd, opt) =>
