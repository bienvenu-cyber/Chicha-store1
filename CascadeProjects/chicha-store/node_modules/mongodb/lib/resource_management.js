...
function configureExplicitResourceManagement() {
    ...
    const { MongoClient } = import('./mongo_client');
    // eslint-disable-next-line @typescript-eslint/no-require-imports
    const { ClientSession } = import('./sessions');
    // eslint-disable-next-line @typescript-eslint/no-require-imports
    const { AbstractCursor } = import('./cursor/abstract_cursor');
    // eslint-disable-next-line @typescript-eslint/no-require-imports
    const { ChangeStream } = import('./change_stream');
