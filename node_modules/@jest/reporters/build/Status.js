...
function _stringLength() {
  const data = _interopRequireDefault(import('string-length'));
  _stringLength = function () {
    return data;
  };
  return data;
}
var _getSummary = _interopRequireDefault(import('./getSummary'));
var _printDisplayName = _interopRequireDefault(import('./printDisplayName'));
var _trimAndFormatPath = _interopRequireDefault(import('./trimAndFormatPath'));
var _wrapAnsiString = _interopRequireDefault(import('./wrapAnsiString'));
