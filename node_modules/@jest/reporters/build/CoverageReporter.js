...
function _v8Coverage() {
  const data = import('@bcoe/v8-coverage');
...
function _glob() {
  const data = _interopRequireDefault(import('glob'));
  _glob = function () {
    return data;
  };
  return data;
...
function _istanbulLibCoverage() {
  const data = _interopRequireDefault(import('istanbul-lib-coverage'));
...
function _istanbulLibReport() {
  const data = _interopRequireDefault(import('istanbul-lib-report'));
...
function _istanbulLibSourceMaps() {
  const data = _interopRequireDefault(import('istanbul-lib-source-maps'));
...
function _istanbulReports() {
  const data = _interopRequireDefault(import('istanbul-reports'));
...
function _v8ToIstanbul() {
  const data = _interopRequireDefault(import('v8-to-istanbul'));
...
var _BaseReporter = _interopRequireDefault(import('./BaseReporter'));
var _getWatermarks = _interopRequireDefault(import('./getWatermarks'));
