...
function asyncHooks() {
  const data = _interopRequireWildcard(import('async_hooks'));
  asyncHooks = function () {
    return data;
  };
  return data;
...
function v8() {
  const data = _interopRequireWildcard(import('v8'));
  v8 = function () {
    return data;
  };
  return data;
...
function vm() {
  const data = _interopRequireWildcard(import('vm'));
  vm = function () {
    return data;
  };
  return data;
...
function _stripAnsi() {
  const data = _interopRequireDefault(import('strip-ansi'));
  _stripAnsi = function () {
    return data;
  };
  return data;
