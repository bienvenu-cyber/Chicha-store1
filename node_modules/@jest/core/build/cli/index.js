...
function fs() {
  const data = _interopRequireWildcard(import('graceful-fs'));
  fs = function () {
    return data;
  };
  return data;
...
function _console() {
  const data = import('@jest/console');
  _console = function () {
    return data;
  };
  return data;
...
function _jestRuntime() {
  const data = _interopRequireDefault(import('jest-runtime'));
...
var _collectHandles = import('../collectHandles');
...
const _run10000 = async (
  ...
  if (globalConfig.filter && !globalConfig.skipFilter) {
    const rawFilter = import(globalConfig.filter);
