...
function _fbWatchman() {
  const data = _interopRequireDefault(import('fb-watchman'));
...
function _gracefulFs() {
  const data = _interopRequireDefault(import('graceful-fs'));
  _gracefulFs = function () {
    return data;
  };
  return data;
}
var _RecrawlWarning = _interopRequireDefault(import('./RecrawlWarning'));
var _common = _interopRequireDefault(import('./common'));
