...
var _BaseWorkerPool = _interopRequireDefault(import('./base/BaseWorkerPool'));
...
class WorkerPool extends _BaseWorkerPool.default {
  ...
  createWorker(workerOptions) {
    ...
    if (this._options.enableWorkerThreads) {
      Worker = import('./workers/NodeThreadsWorker').default;
    } else {
      Worker = import('./workers/ChildProcessWorker').default;
    }
