...
var _Farm = _interopRequireDefault(import('./Farm'));
var _WorkerPool = _interopRequireDefault(import('./WorkerPool'));
var _PriorityQueue = _interopRequireDefault(import('./PriorityQueue'));
var _FifoQueue = _interopRequireDefault(import('./FifoQueue'));
var _messageParent = _interopRequireDefault(import('./workers/messageParent'));
...
function getExposedMethods(workerPath, options) {
  ...
  if (!exposedMethods) {
    const module = import(workerPath);
