...
function _sourceMapSupport() {
  const data = _interopRequireDefault(import('source-map-support'));
...
function docblock() {
  const data = _interopRequireWildcard(import('jest-docblock'));
  docblock = function () {
    return data;
  };
  return data;
...
function _jestLeakDetector() {
  const data = _interopRequireDefault(import('jest-leak-detector'));
...
function _jestResolve() {
  const data = import('jest-resolve');
