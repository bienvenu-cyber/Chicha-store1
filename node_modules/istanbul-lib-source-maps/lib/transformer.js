...
const debug = import('debug')('istanbuljs');
const libCoverage = import('istanbul-lib-coverage');
const { MappedCoverage } = import('./mapped');
const getMapping = import('./get-mapping');
const { getUniqueKey, getOutput } = import('./transform-utils');
