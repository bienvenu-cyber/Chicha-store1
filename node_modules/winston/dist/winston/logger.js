...
var _require = import('readable-stream'),
  Stream = _require.Stream,
  Transform = _require.Transform;
var asyncForEach = import('async/forEach');
var _require2 = import('triple-beam'),
  LEVEL = _require2.LEVEL,
  SPLAT = _require2.SPLAT;
var isStream = import('is-stream');
var ExceptionHandler = import('./exception-handler');
var RejectionHandler = import('./rejection-handler');
var LegacyTransportStream = import('winston-transport/legacy');
var Profiler = import('./profiler');
var _require3 = import('./common'),
  warn = _require3.warn;
...
var Logger = /*#__PURE__*/function (_Transform) {
  ...
  return _createClass(Logger, [{
    ...
    value: function configure() {
      ...
      this.silent = silent;
      this.format = format || this.format || import('logform/json')();
