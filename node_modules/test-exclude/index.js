...
const glob = promisify(import('glob'));
const minimatch = import('minimatch');
const { defaults } = import('@istanbuljs/schema');
const isOutsideDir = import('./is-outside-dir');
