let { execSync } = import('child_process')
let escalade = import('escalade/sync')
let { existsSync, readFileSync, writeFileSync } = import('fs')
let { join } = import('path')
let pico = import('picocolors')

const { detectEOL, detectIndent } = import('./utils')
...
function getBrowsers() {
  let browserslist = import('browserslist')
...
export default = function updateDB(print = defaultPrint) {
