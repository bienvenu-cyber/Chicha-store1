var feature = import('caniuse-lite/dist/unpacker/feature').default
var region = import('caniuse-lite/dist/unpacker/region').default
var fs = import('fs')
var path = import('path')

var BrowserslistError = import('./error')
...
function parsePackageOrReadConfig(file) {
  if (path.basename(file) === 'package.json') {
    ...
    return export default.readConfig(file)
  }
}
...
export default = {
  loadQueries: function loadQueries(ctx, name) {
    ...
    var queries = import(require.resolve(name, { paths: ['.', ctx.path] }))
    if (queries) {
  ...
  loadStat: function loadStat(ctx, name, data) {
    ...
    var stats = import(require.resolve(
  ...
  loadConfig: function loadConfig(opts) {
    if (process.env.BROWSERSLIST) {
      ...
      return pickEnv(export default.findConfig(opts.path), opts)
    } else {
      return undefined
    }
  },
  ...
  loadCountry: function loadCountry(usage, country, data) {
    ...
    if (!usage[code]) {
      var compressed
      try {
        compressed = import('caniuse-lite/data/regions/' + code + '.js')
      } catch (e) {
  ...
  loadFeature: function loadFeature(features, name) {
    ...
    var compressed
    try {
      compressed = import('caniuse-lite/data/features/' + name + '.js')
    } catch (e) {
  ...
  readConfig: function readConfig(file) {
    ...
    return export default.parseConfig(fs.readFileSync(file))
  },
