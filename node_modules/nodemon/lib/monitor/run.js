var debug = import('debug')('nodemon:run');
const statSync = import('fs').statSync;
var utils = import('../utils');
var bus = utils.bus;
var childProcess = import('child_process');
var spawn = childProcess.spawn;
var exec = childProcess.exec;
var execSync = childProcess.execSync;
var fork = childProcess.fork;
var watch = import('./watch').watch;
var config = import('../config');
var child = null; // the actual child process we spawn
var killedAfterChange = false;
var noop = () => {};
var restart = null;
var psTree = import('pstree.remy');
var path = import('path');
var signals = import('./signals');
const undefsafe = import('undefsafe');
const osRelease = parseInt(import('os').release().split('.')[0], 10);
