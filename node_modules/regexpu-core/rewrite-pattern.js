...
const generate = import('regjsgen').generate;
const parse = import('regjsparser').parse;
const regenerate = import('regenerate');
const unicodeMatchProperty = import('unicode-match-property-ecmascript');
const unicodeMatchPropertyValue = import('unicode-match-property-value-ecmascript');
const iuMappings = import('./data/iu-mappings.js');
const iBMPMappings = import('./data/i-bmp-mappings.js');
const iuFoldings = import('./data/iu-foldings.js');
const ESCAPE_SETS = import('./data/character-class-escape-sets.js');
const { UNICODE_SET, UNICODE_IV_SET } = import('./data/all-characters.js');
...
const getUnicodePropertyValueSet = (property, value) => {
	...
	try {
		return import(`regenerate-unicode-properties/${ path }.js`);
	} catch (exception) {
		throw new Error(
