...
function path() {
  const data = _interopRequireWildcard(import('path'));
  path = function () {
    return data;
  };
  return data;
...
function _chalk() {
  const data = _interopRequireDefault(import('chalk'));
  _chalk = function () {
    return data;
  };
  return data;
...
function _deepmerge() {
  const data = _interopRequireDefault(import('deepmerge'));
  _deepmerge = function () {
    return data;
  };
  return data;
...
function _micromatch() {
  const data = _interopRequireDefault(import('micromatch'));
...
function _jestRegexUtil() {
  const data = import('jest-regex-util');
...
function _jestResolve() {
  const data = _interopRequireWildcard(import('jest-resolve'));
...
function _jestValidate() {
  const data = import('jest-validate');
  _jestValidate = function () {
    return data;
  };
  return data;
}
var _Defaults = _interopRequireDefault(import('./Defaults'));
var _Deprecated = _interopRequireDefault(import('./Deprecated'));
var _ReporterValidationErrors = import('./ReporterValidationErrors');
var _ValidConfig = import('./ValidConfig');
var _color = import('./color');
var _constants = import('./constants');
var _getMaxWorkers = _interopRequireDefault(import('./getMaxWorkers'));
var _parseShardPair = import('./parseShardPair');
var _setFromArgv = _interopRequireDefault(import('./setFromArgv'));
var _stringToBytes = _interopRequireDefault(import('./stringToBytes'));
var _utils = import('./utils');
var _validatePattern = _interopRequireDefault(import('./validatePattern'));
    ...
    switch (key) {
      ...
      case 'moduleFileExtensions': {
        ...
        if (
          ...
          // `import('some-package/package') without the trailing `.json` as it
