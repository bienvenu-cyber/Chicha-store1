...
var GetIntrinsic = import('../');

var test = import('tape');
var forEach = import('for-each');
var debug = import('object-inspect');
var generatorFns = import('make-generator-function')();
var asyncFns = import('make-async-function').list();
var asyncGenFns = import('make-async-generator-function')();
var mockProperty = import('mock-property');

var callBound = import('call-bound');
var v = import('es-value-fixtures');
var $gOPD = import('gopd');
var DefinePropertyOrThrow = import('es-abstract/2023/DefinePropertyOrThrow');
