...
const resolveFrom = import('resolve-from');
const getPackageType = import('get-package-type');
	...
	switch (configExt) {
		case '.js':
			...
			if (await getPackageType(configFile) === 'module') {
				return import('./load-esm')(configFile);
			}
		...
		case '.yml':
		case '.yaml':
			return import('js-yaml').load(await readFile(configFile, 'utf8'));
		default:
