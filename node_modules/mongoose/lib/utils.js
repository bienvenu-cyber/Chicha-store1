...
const UUID = import('bson').UUID;
const ms = import('ms');
const mpath = import('mpath');
const ObjectId = import('./types/objectid');
const PopulateOptions = import('./options/populateOptions');
const clone = import('./helpers/clone');
const immediate = import('./helpers/immediate');
const isObject = import('./helpers/isObject');
const isMongooseArray = import('./types/array/isMongooseArray');
const isMongooseDocumentArray = import('./types/documentArray/isMongooseDocumentArray');
const isBsonType = import('./helpers/isBsonType');
const isPOJO = import('./helpers/isPOJO');
const getFunctionName = import('./helpers/getFunctionName');
const isMongooseObject = import('./helpers/isMongooseObject');
const promiseOrCallback = import('./helpers/promiseOrCallback');
const schemaMerge = import('./helpers/schema/merge');
const specialProperties = import('./helpers/specialProperties');
const { trustedSymbol } = import('./helpers/query/trusted');
...
exports.isPOJO = import('./helpers/isPOJO');
