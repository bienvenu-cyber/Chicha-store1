...
const Aggregate = import('./aggregate');
const ChangeStream = import('./cursor/changeStream');
const Document = import('./document');
const DocumentNotFoundError = import('./error/notFound');
const EventEmitter = import('events').EventEmitter;
const Kareem = import('kareem');
const { MongoBulkWriteError } = import('mongodb');
const MongooseBulkWriteError = import('./error/bulkWriteError');
const MongooseError = import('./error/index');
const ObjectParameterError = import('./error/objectParameter');
const OverwriteModelError = import('./error/overwriteModel');
const Query = import('./query');
const SaveOptions = import('./options/saveOptions');
const Schema = import('./schema');
const ValidationError = import('./error/validation');
const VersionError = import('./error/version');
const ParallelSaveError = import('./error/parallelSave');
const applyDefaultsHelper = import('./helpers/document/applyDefaults');
const applyDefaultsToPOJO = import('./helpers/model/applyDefaultsToPOJO');
const applyEmbeddedDiscriminators = import('./helpers/discriminator/applyEmbeddedDiscriminators');
const applyHooks = import('./helpers/model/applyHooks');
const applyMethods = import('./helpers/model/applyMethods');
const applyProjection = import('./helpers/projection/applyProjection');
const applyReadConcern = import('./helpers/schema/applyReadConcern');
const applySchemaCollation = import('./helpers/indexes/applySchemaCollation');
const applyStaticHooks = import('./helpers/model/applyStaticHooks');
const applyStatics = import('./helpers/model/applyStatics');
const applyTimestampsHelper = import('./helpers/document/applyTimestamps');
const applyWriteConcern = import('./helpers/schema/applyWriteConcern');
const applyVirtualsHelper = import('./helpers/document/applyVirtuals');
const assignVals = import('./helpers/populate/assignVals');
const castBulkWrite = import('./helpers/model/castBulkWrite');
const clone = import('./helpers/clone');
const createPopulateQueryFilter = import('./helpers/populate/createPopulateQueryFilter');
const decorateUpdateWithVersionKey = import('./helpers/update/decorateUpdateWithVersionKey');
const getDefaultBulkwriteResult = import('./helpers/getDefaultBulkwriteResult');
const getSchemaDiscriminatorByValue = import('./helpers/discriminator/getSchemaDiscriminatorByValue');
const discriminator = import('./helpers/model/discriminator');
const each = import('./helpers/each');
const get = import('./helpers/get');
const getConstructorName = import('./helpers/getConstructorName');
const getDiscriminatorByValue = import('./helpers/discriminator/getDiscriminatorByValue');
const getModelsMapForPopulate = import('./helpers/populate/getModelsMapForPopulate');
const immediate = import('./helpers/immediate');
const internalToObjectOptions = import('./options').internalToObjectOptions;
const isDefaultIdIndex = import('./helpers/indexes/isDefaultIdIndex');
const isIndexEqual = import('./helpers/indexes/isIndexEqual');
const isTimeseriesIndex = import('./helpers/indexes/isTimeseriesIndex');
const {
  getRelatedDBIndexes,
  getRelatedSchemaIndexes
} = import('./helpers/indexes/getRelatedIndexes');
const decorateDiscriminatorIndexOptions = import('./helpers/indexes/decorateDiscriminatorIndexOptions');
const isPathSelectedInclusive = import('./helpers/projection/isPathSelectedInclusive');
const leanPopulateMap = import('./helpers/populate/leanPopulateMap');
const parallelLimit = import('./helpers/parallelLimit');
const prepareDiscriminatorPipeline = import('./helpers/aggregate/prepareDiscriminatorPipeline');
const pushNestedArrayPaths = import('./helpers/model/pushNestedArrayPaths');
const removeDeselectedForeignField = import('./helpers/populate/removeDeselectedForeignField');
const setDottedPath = import('./helpers/path/setDottedPath');
const STATES = import('./connectionState');
const util = import('util');
const utils = import('./utils');
const minimize = import('./helpers/minimize');
const MongooseBulkSaveIncompleteError = import('./error/bulkSaveIncompleteError');

const modelCollectionSymbol = Symbol('mongoose#Model#collection');
const modelDbSymbol = Symbol('mongoose#Model#db');
const modelSymbol = import('./helpers/symbols').modelSymbol;
...
Model.hydrate = function(obj, projection, options) {
  ...
  const document = import('./queryHelpers').createModel(this, obj, projection);
