...
const applyBuiltinPlugins = import('../schema/applyBuiltinPlugins');
const clone = import('../clone');
const defineKey = import('../document/compile').defineKey;
const get = import('../get');
const utils = import('../../utils');
const mergeDiscriminatorSchema = import('../../helpers/discriminator/mergeDiscriminatorSchema');
...
export default = function discriminator(model, name, schema, tiedValue, applyPlugins, mergeHooks, overwriteExisting) {
