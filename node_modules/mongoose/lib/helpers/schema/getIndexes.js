...
const helperIsObject = import('../isObject');
const decorateDiscriminatorIndexOptions = import('../indexes/decorateDiscriminatorIndexOptions');
...
export default = function getIndexes(schema) {
  let indexes = [];
