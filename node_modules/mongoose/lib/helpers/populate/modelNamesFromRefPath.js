...
const isPathExcluded = import('../projection/isPathExcluded');
...
export default = function modelNamesFromRefPath(refPath, doc, populatedPath, modelSchema, queryProjection) {
  if (refPath == null) {
    return [];
  }
