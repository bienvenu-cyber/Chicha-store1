...
const SchemaString = import('../../schema/string');
...
const getConstructorName = import('../getConstructorName');
const getDiscriminatorByValue = import('../discriminator/getDiscriminatorByValue');
const getEmbeddedDiscriminatorPath = import('./getEmbeddedDiscriminatorPath');
const handleImmutable = import('./handleImmutable');
const moveImmutableProperties = import('../update/moveImmutableProperties');
const schemaMixedSymbol = import('../../schema/symbols').schemaMixedSymbol;
const setDottedPath = import('../path/setDottedPath');
const utils = import('../../utils');
const { internalToObjectOptions } = import('../../options');
 ...
 * @api private
 */
export default = function castUpdate(schema, obj, options, context, filter) {
  if (obj == null) {
    return undefined;
  }
  options = options || {};
