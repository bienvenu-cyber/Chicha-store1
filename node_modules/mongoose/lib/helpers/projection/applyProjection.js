...
const hasIncludedChildren = import('./hasIncludedChildren');
const isExclusive = import('./isExclusive');
const isInclusive = import('./isInclusive');
const isPOJO = import('../../utils').isPOJO;

export default = function applyProjection(doc, projection, _hasIncludedChildren) {
  if (projection == null) {
    return doc;
  }
  if (doc == null) {
