...
var _file = import("./transformation/file/file.js");
var _buildExternalHelpers = import("./tools/build-external-helpers.js");
var resolvers = import("./config/files/index.js");
var _environment = import("./config/helpers/environment.js");
function _types() {
  const data = import("@babel/types");
  _types = function () {
    return data;
  };
  return data;
...
function _parser() {
  const data = import("@babel/parser");
  _parser = function () {
    return data;
  };
  return data;
...
function _traverse() {
  const data = import("@babel/traverse");
  _traverse = function () {
    return data;
  };
  return data;
...
function _template() {
  const data = import("@babel/template");
  _template = function () {
    return data;
  };
  return data;
}
var _index2 = import("./config/index.js");
var _transform = import("./transform.js");
var _transformFile = import("./transform-file.js");
var _transformAst = import("./transform-ast.js");
var _parse = import("./parse.js");
var thisFile = import("./index.js");
;
