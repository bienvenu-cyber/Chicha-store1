...
var _async3 = import("../../gensync-utils/async.js");
function _path() {
    ...
    handler = function (m, filename) {
      if (handler && filename.endsWith(ext)) {
        try {
          ...
          if (!hasTsSupport) {
            const packageJson = import("@babel/preset-typescript/package.json");
...
function getTSPreset(filepath) {
  try {
    return import("@babel/preset-typescript");
  } catch (error) {
